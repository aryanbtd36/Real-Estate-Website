...
import { Calendar, Clock, User, Building, Search, Filter, Check, X, ShieldAlert, Eye, MessageSquare } from 'lucide-react';
                  ...
                  {!showReschedule ? (
                    <div className="flex flex-wrap gap-2">
                      {(selectedAppointment.status === 'PENDING' || selectedAppointment.status === 'CANCELLED') && (
                        <button
                          ...
                          className="flex-1 min-w-[100px] px-3 py-2 bg-green-500/10 border border-green-500/20 hover:bg-green-500 hover:text-black text-green-400 text-[10px] uppercase tracking-widest font-bold rounded transition-colors"
                        >
                          Approve visit
                        </button>
                      )}
                      ...
                      {selectedAppointment.status === 'CONFIRMED' && (
                        <button
                          ...
                          className="flex-1 min-w-[100px] px-3 py-2 bg-blue-500/10 border border-blue-500/20 hover:bg-blue-500 hover:text-black text-blue-400 text-[10px] uppercase tracking-widest font-bold rounded transition-colors"
                        >
                          Mark Complete
                        </button>
                      )}
                      ...
                      {selectedAppointment.status !== 'CANCELLED' && selectedAppointment.status !== 'COMPLETED' && (
                        <>
                          <button
                            ...
                            className="flex-1 min-w-[100px] px-3 py-2 bg-[#D4AF37]/10 border border-[#D4AF37]/25 hover:bg-[#D4AF37] hover:text-black text-[#F5D67B] text-[10px] uppercase tracking-widest font-bold rounded transition-colors"
                          >
                            Reschedule
                          </button>
                          <button
                            ...
                            className="flex-1 min-w-[100px] px-3 py-2 bg-red-500/10 border border-red-500/20 hover:bg-red-500 hover:text-black text-red-400 text-[10px] uppercase tracking-widest font-bold rounded transition-colors"
                          >
                            Cancel visit
                          </button>
                        </>
                    ...
                    <form onSubmit={handleResubmitReschedule} className="bg-[#0A0A0A] p-4 rounded-lg border border-white/5 space-y-4">
                      ...
                      <button
                        type="submit"
                        disabled={actionLoading}
                        className="w-full py-2 bg-gradient-to-r from-[#D4AF37] to-[#F5D67B] text-black text-[10px] font-bold uppercase tracking-widest rounded hover:opacity-90"
                      >
                        Confirm Reschedule
                      </button>
                    </form>
