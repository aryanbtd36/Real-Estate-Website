  ...
  if (sessionStatus === 'loading' || loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] bg-[#0A0A0A] text-white">
        ...
        <span className="text-xs uppercase tracking-widest text-white/40">Loading Platform CMS Panel...</span>
      </div>
    );
  }
    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-white/5 pb-6">
        <div>
          ...
          <p className="text-xs text-white/50 mt-1">Control landing homepage sections, copy text, layout orders, testimonials, and locality statistics.</p>
        </div>
        <button
      ...
      <div className="space-y-8">
        ...
        {activeTab === 'general' && (
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
            <div className="xl:col-span-8 space-y-8">
              {/* Hero Copy Panel */}
              <div className="bg-[#161616] border border-white/5 p-6 rounded-xl space-y-6">
                <h3 className="text-sm font-semibold uppercase tracking-wider text-[#D4AF37] border-b border-white/5 pb-2">Hero Showcase Segment</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5 sm:col-span-2">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Main Headline Title</label>
                    <input
                      type="text"
                      value={heroConfig.headline || ''}
                      onChange={(e) => setHeroConfig({ ...heroConfig, headline: e.target.value })}
                      className="w-full bg-[#0A0A0A] border border-white/10 rounded p-2.5 text-xs text-white focus:border-[#D4AF37]/50 focus:outline-none"
                    />
                  </div>
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Highlighted text</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Visibility Toggle</label>
                    <select
                  ...
                  <div className="space-y-1.5 sm:col-span-2">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Subheadline Copy Description</label>
                    <textarea
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Primary CTA Label</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Primary CTA Action URL</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Secondary CTA Label</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Secondary CTA Action URL</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Background media url</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Background Type</label>
                    <select
                ...
                <button
                  ...
                  className="px-4 py-2 bg-[#D4AF37] hover:bg-[#C5A030] text-black text-[10px] uppercase font-bold tracking-widest rounded transition-colors disabled:opacity-50"
                >
                  Save Hero Settings
                </button>
              </div>
              ...
              {/* Announcement Banner */}
              <div className="bg-[#161616] border border-white/5 p-6 rounded-xl space-y-6">
                <h3 className="text-sm font-semibold uppercase tracking-wider text-[#D4AF37] border-b border-white/5 pb-2">Announcement Header Strip</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Banner title badge</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Strip visibility</label>
                    <select
                  ...
                  <div className="space-y-1.5 sm:col-span-2">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Banner narrative description</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">CTA Button text</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">CTA redirect url</label>
                    <input
                      type="text"
              ...
              <div className="bg-[#161616] border border-white/5 p-6 rounded-xl space-y-6">
                <h3 className="text-sm font-semibold uppercase tracking-wider text-[#D4AF37] border-b border-white/5 pb-2">Featured Listings Spotlight Mode</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Selection Algorithm</label>
                    <select
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Manual Property IDs (Comma-separated)</label>
                    <input
                      type="text"
                      ...
                      className="w-full bg-[#0A0A0A] border border-white/10 rounded p-2.5 text-xs text-white focus:border-[#D4AF37]/50 focus:outline-none disabled:opacity-40"
                    />
                  </div>
                </div>
                <button
              ...
              <div className="bg-[#161616] border border-white/5 p-6 rounded-xl space-y-6">
                <h3 className="text-sm font-semibold uppercase tracking-wider text-[#D4AF37] border-b border-white/5 pb-2">Footer Site Map & Info</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5 sm:col-span-2">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Company overview text</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Contact Hotline Phone</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Support Email Address</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1.5 sm:col-span-2">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Footer Navigation Links JSON Structure</label>
                    <textarea
                      value={footerConfig.linksJson || ''}
                      onChange={(e) => setFooterConfig({ ...footerConfig, linksJson: e.target.value })}
                      rows={6}
                      className="w-full bg-[#0A0A0A] font-mono border border-white/10 rounded p-2.5 text-xs text-white focus:border-[#D4AF37]/50 focus:outline-none"
                    />
                  </div>
                  <div className="space-y-1.5 sm:col-span-2">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Footer Social Links JSON Structure</label>
                    <textarea
            ...
            <div className="xl:col-span-4 space-y-8">
              <div className="bg-[#161616] border border-white/5 p-6 rounded-xl space-y-6">
                <h3 className="text-sm font-semibold uppercase tracking-wider text-[#D4AF37] border-b border-white/5 pb-2 flex items-center gap-1.5">
                  <Globe size={16} />
                  <span>SEO & Meta Parameters</span>
                </h3>
                <div className="space-y-4">
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Meta Title Tag</label>
                    <input
                      type="text"
                      value={seoConfig.metaTitle || ''}
                      onChange={(e) => setSeoConfig({ ...seoConfig, metaTitle: e.target.value })}
                      className="w-full bg-[#0A0A0A] border border-white/10 rounded p-2 text-xs text-white focus:border-[#D4AF37]/50 focus:outline-none"
                    />
                  </div>
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Meta Description</label>
                    <textarea
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Keywords (Comma-separated)</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">OG Social Preview Image Url</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase text-white/50 block font-bold">Canonical Tag URL</label>
                    <input
                      type="text"
                ...
                <button
                  ...
                  className="w-full py-2 bg-[#D4AF37] hover:bg-[#C5A030] text-black text-[10px] uppercase font-bold tracking-widest rounded transition-colors disabled:opacity-50"
                >
                  Save SEO Parameters
                </button>
              </div>
        ...
        {activeTab === 'layout' && (
          <div className="bg-[#161616] border border-white/5 p-6 rounded-xl space-y-6 max-w-3xl">
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wider text-[#D4AF37] border-b border-white/5 pb-2 flex items-center gap-1.5">
                <ListOrdered size={16} />
                <span>Section Ordering & Visibility Layout</span>
              </h3>
              <p className="text-xs text-white/40 mt-1">Re-order blocks vertically on the homepage and toggle their visibility directly.</p>
            </div>
            ...
            <div className="space-y-3">
              {sectionsList.map((section, idx) => (
                <div key={section.id} className={`p-4 rounded-lg border flex justify-between items-center transition-all ${
                  section.visible ? 'bg-[#0A0A0A] border-white/5' : 'bg-[#0A0A0A]/40 border-white/5 opacity-50'
                }`}>
                  <div className="flex items-center gap-3">
                    <span className="text-[10px] font-mono text-white/30">#{idx + 1}</span>
                    <div>
                      <span className="font-semibold text-xs text-white block">{section.name}</span>
                      <span className="text-[9px] uppercase tracking-wider text-white/40">ID: {section.id}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      disabled={idx === 0}
                      className="p-2 border border-white/5 bg-[#1C1C1C] hover:bg-[#252525] text-white rounded disabled:opacity-30 disabled:pointer-events-none"
                    >
                      <MoveUp size={12} />
                    </button>
                    <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-[#161616] border border-white/5 p-6 rounded-xl space-y-6">
              <div className="flex justify-between items-center border-b border-white/5 pb-3">
                ...
                <button
                  ...
                  className="px-2.5 py-1 bg-[#1E1E1E] hover:bg-[#252525] border border-white/5 hover:border-white/10 text-xs font-bold uppercase tracking-wider text-white flex items-center gap-1.5 rounded"
                >
                  <Plus size={12} />
              ...
              <div className="space-y-3">
                {heroMetrics.map((m) => (
                  <div key={m.id} className="p-3.5 bg-[#0A0A0A] border border-white/5 rounded-lg flex justify-between items-center">
                    <div>
                      <div className="flex items-center gap-2">
                      ...
                      <span className="text-lg font-light text-[#D4AF37] mt-1 block">{m.value}{m.suffix}</span>
                      <span className="text-[9px] text-white/30">Display order: #{m.displayOrder} • Icon: {m.icon}</span>
                    </div>
            ...
            {editingMetric && (
              <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
                <div className="bg-[#161616] border border-white/10 p-6 rounded-xl w-full max-w-md space-y-4">
                  <h3 className="text-sm font-semibold uppercase tracking-wider text-[#D4AF37] border-b border-white/5 pb-2">
                    {editingMetric.id ? 'Edit' : 'Create'} {metricType === 'hero' ? 'Hero Metric' : 'Trust Counter'}
                  </h3>
                  <form onSubmit={handleSaveMetric} className="space-y-4">
                    <div className="space-y-1.5">
                      <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Metric Label Title</label>
                      <input
                        type="text"
                        required
                        value={editingMetric.title || ''}
                        onChange={(e) => setEditingMetric({ ...editingMetric, title: e.target.value })}
                        className="w-full bg-[#0A0A0A] border border-white/10 rounded px-3 py-2 text-xs text-white focus:border-[#D4AF37]/50 focus:outline-none"
                      />
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Number value</label>
                        <input
                          type="text"
                          required
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Unit suffix</label>
                        <input
                          type="text"
                          placeholder="e.g. + or %"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Lucide Icon name</label>
                        <input
                          type="text"
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Display Order</label>
                        <input
                          type="number"
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Visibility Mode</label>
                      <select
                        value={String(editingMetric.visible)}
                        onChange={(e) => setEditingMetric({ ...editingMetric, visible: e.target.value === 'true' })}
                        className="w-full bg-[#0A0A0A] border border-white/10 rounded px-3 py-2 text-xs text-white focus:border-[#D4AF37]/50"
                      >
                        <option value="true">Visible</option>
                        <option value="false">Hidden</option>
                      </select>
                    ...
                    <div className="flex justify-end gap-3 pt-3 border-t border-white/5">
                      <button
                        ...
                        className="px-4 py-2 border border-white/5 bg-[#1C1C1C] hover:bg-[#252525] text-white text-[10px] uppercase font-bold tracking-widest rounded"
                      >
                        Cancel
                      </button>
                      <button
                        type="submit"
                        className="px-4 py-2 bg-[#D4AF37] hover:bg-[#C5A030] text-black text-[10px] uppercase font-bold tracking-widest rounded"
                      >
                        Save Metric
                      </button>
                    </div>
        ...
        {activeTab === 'localities' && (
          <div className="bg-[#161616] border border-white/5 p-6 rounded-xl space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {localities.map((loc) => (
                <div key={loc.id} className="p-4 bg-[#0A0A0A] border border-white/5 rounded-lg space-y-4 hover:border-[#D4AF37]/25 transition-all">
                  <div className="flex justify-between items-start">
                    <div>
                      <span className="font-semibold text-white text-sm">{loc.areaName}</span>
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center">
                    <div className="p-2 bg-[#121212] border border-white/5 rounded">
                      <span className="text-[8px] text-white/40 uppercase block">Growth</span>
                      <span className="text-sm font-semibold text-white mt-1 block">{loc.growthScore}/100</span>
                    </div>
                    <div className="p-2 bg-[#121212] border border-white/5 rounded">
                      <span className="text-[8px] text-white/40 uppercase block">Demand</span>
                      <span className="text-sm font-semibold text-white mt-1 block">{loc.demandScore}/100</span>
                    </div>
                    <div className="p-2 bg-[#121212] border border-white/5 rounded">
                      <span className="text-[8px] text-white/40 uppercase block">Connect</span>
                      <span className="text-sm font-semibold text-white mt-1 block">{loc.connectivityScore}/100</span>
                    </div>
                  </div>

                  <div className="flex justify-between items-center text-[10px] text-white/40 border-t border-white/5 pt-3 mt-1">
              ...
              <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
                <div className="bg-[#161616] border border-white/10 p-6 rounded-xl w-full max-w-md space-y-4">
                  ...
                  <form onSubmit={handleSaveLocality} className="space-y-4">
                    <div className="space-y-1.5">
                      <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Locality Area Name</label>
                      <input
                        type="text"
                        required
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div className="space-y-1.5">
                        <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Growth (0-100)</label>
                        <input
                          type="number"
                          required
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Demand (0-100)</label>
                        <input
                          type="number"
                          required
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Connectivity (0-100)</label>
                        <input
                          type="number"
                          required
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Investment Rating</label>
                        <select
        ...
        {activeTab === 'testimonials' && (
          <div className="bg-[#161616] border border-white/5 p-6 rounded-xl space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {testimonials.map((t) => (
                <div key={t.id} className="p-5 bg-[#0A0A0A] border border-white/5 rounded-lg space-y-3 relative hover:border-[#D4AF37]/25 transition-all">
                  <div className="flex gap-4 items-center">
                    <div className="w-12 h-12 bg-white/5 rounded-full border border-white/10 flex items-center justify-center text-[#D4AF37] font-semibold text-sm">
                      {t.name.charAt(0)}
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] text-white/40 block mt-0.5">{t.location} • Purchased {t.propertyType}</span>
                    </div>
                  </div>

                  <p className="text-xs text-white/70 italic leading-relaxed">"{t.review}"</p>

                  <div className="flex justify-between items-center text-[10px] text-white/30 border-t border-white/5 pt-3 mt-2">
            ...
            {editingTestimonial && (
              <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
                <div className="bg-[#161616] border border-white/10 p-6 rounded-xl w-full max-w-lg space-y-4">
                  <h3 className="text-sm font-semibold uppercase tracking-wider text-[#D4AF37] border-b border-white/5 pb-2">
                  ...
                  <form onSubmit={handleSaveTestimonial} className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Client Name</label>
                        <input
                          type="text"
                          required
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Client Location</label>
                        <input
                          type="text"
                          required
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div className="space-y-1.5">
                        <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Property Type Purchased</label>
                        <input
                          type="text"
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Rating (1-5)</label>
                        <input
                          type="number"
                          min={1}
                          max={5}
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Testimonial Review Text</label>
                      <textarea
                        required
                        rows={4}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Featured Review</label>
                        <select
        ...
        {activeTab === 'research' && (
          <div className="bg-[#161616] border border-white/5 p-6 rounded-xl space-y-6">
            ...
            <div className="space-y-4">
              {articles.map((art) => (
                <div key={art.id} className="p-4 bg-[#0A0A0A] border border-white/5 rounded-lg flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 hover:border-[#D4AF37]/25 transition-all">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <span className="font-semibold text-xs text-white">{art.title}</span>
                    ...
                    <p className="text-[10px] text-white/40">
                      Slug: <code className="text-white/30 bg-white/5 px-1 rounded">{art.slug}</code> • Author: {art.author} • Published: {new Date(art.publishedDate).toLocaleDateString()}
                    </p>
                  </div>
                  <div className="flex gap-2">
                    <button
            ...
            {editingArticle && (
              <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
                <div className="bg-[#161616] border border-white/10 p-6 rounded-xl w-full max-w-2xl space-y-4">
                  <h3 className="text-sm font-semibold uppercase tracking-wider text-[#D4AF37] border-b border-white/5 pb-2">
                    {editingArticle.id ? 'Edit' : 'Write'} Intelligence Article
                  </h3>
                  <form onSubmit={handleSaveArticle} className="space-y-4">
                    <div className="space-y-1.5">
                      <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Article Title</label>
                      <input
                        type="text"
                        required
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Url Slug</label>
                        <input
                          type="text"
                          required
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Author attribution</label>
                        <input
                          type="text"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Thumbnail image url</label>
                        <input
                          type="text"
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Publication Status</label>
                        <select
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[9px] uppercase tracking-widest text-white/50 block font-bold">Article Content (Markdown/HTML supported)</label>
                      <textarea
                        required
                        rows={8}
                        value={editingArticle.content || ''}
                        onChange={(e) => setEditingArticle({ ...editingArticle, content: e.target.value })}
                        className="w-full bg-[#0A0A0A] font-mono border border-white/10 rounded px-3 py-2 text-xs text-white focus:border-[#D4AF37]/50 focus:outline-none"
                      />
                    </div>
